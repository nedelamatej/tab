...
CREATE TABLE pitch (id INT AUTO_INCREMENT NOT NULL,
  ...
  v_t             DOUBLE PRECISION NOT NULL,
  phi_t           DOUBLE PRECISION NOT NULL,
  theta_t         DOUBLE PRECISION NOT NULL,
...
CREATE TABLE pitcher (id INT AUTO_INCREMENT NOT NULL,
  organization_id INT NOT NULL,
